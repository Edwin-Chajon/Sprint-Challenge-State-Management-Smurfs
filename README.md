...
- [ ] What problem does the context API help solve?
 context API resolves the intricacies and issues with prop drilling too far within an application.
- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?
an action is what you would like  to be executed alongside the state when calling a reducer function and exopecting a certain peice of code to be executed.
- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?
Application State can be reffered to as the global state which all components can access, whereas Component State is only accessible within the local scope of a given component
- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?
redux thunk is a middleware that checks whether an action is a function and calls it if it is, it helps action-creators sift through actions and point out the functions within them
- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!
context API because Redux was too hard...
